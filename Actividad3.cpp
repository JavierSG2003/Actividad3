...
std::string PalabraMala(std::string& rfc) {
    std::string MalaPalabra[] = { "PENE", "PEDO", "JOTO", "PUTO","BAKA" };
    for (size_t i = 0; i < sizeof(MalaPalabra); ++i) {
        size_t found = rfc.find(MalaPalabra[i]);
